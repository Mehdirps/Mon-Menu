 ...
 <div class="container-fluid pt-0 mt-0">
 	<div class="row">
 		...
 		<div class="col-4 col-sm-3 sidebar">
 			...
 			<div class="wrap_logo">
 				<a class="navbar-brand" href="{{$url}}admin/restaurant-{{ $restaurant->id }}">
 					@if($restaurant)
 					<img src="{{$url}}images/restaurants/{{$restaurant->logo}}" alt="">
 					@endif
 				</a>
 			...
 			<div class="col col-categorie {{ $class }}">
 				...
 				<div class="card"> <!-- card -->
 					...
 					<a href="{{ route('singlecat' , [ $restaurant->id, $category->id, $category->slug]) }}">
 						<?php
 						$imgUrl = $category->image ? 'images/'.$category->image.'' : 'img/default.png';
 						?>
 						<img src="{{ asset($imgUrl) }}" alt="{{ $category->name}}">
 					...
 					<h1 class="cat_name text-uppercase">{{-- Accueil / --}}
 						...
 						<div class="rows">
 							<div class="main_category row"> <!-- main_product -->
 								...
 								@include('partial.category', ['category' => $categorie, 'class' => $class])
 							...
 							<div class="main_product row"> <!-- main_product -->
 								...
 								<div class="product col-6 col-sm-6 col-md-4 py-4 @if($loop->even)  @endif"> <!-- product -->
 									<div class="row"> <!-- row -->
...
@endif
 ...
 <div class="modal fade" id="modal_produit_{{$product->id}}" tabindex="-1" aria-labelledby="" aria-hidden="true">
